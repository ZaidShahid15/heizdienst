...
<main>
  ...
  <div class="wolf-hero__inner container">
    ...
    <h1>
      ...
      <span>Rund um die Uhr Service vom Fachbetrieb.</span>
    </h1>
    ...
    <p class="wolf-hero__sub">
      Professionelle Buderus Thermenwartung Wien vom zertifizierten Fachbetrieb –
      Wartung, Service, Reparatur & Notdienst 24/7 in Wien und Umgebung.
    </p>
    ...
    <div class="hero-trust">
      ...
      <div class="rating d-flex gap-3 align-items-center">
        <strong class="d-flex gap-2 align-items-center">
          <img src="{{ asset('img/google-icon.svg') }}" style="width:20px" alt="">
          Google
        </strong>
        <div class="stars">
          ★★★★★
      ...
      <div class="badges" style="margin-top:10px;">
        <div>✓ Geprüfte Experten</div>
        <div>✓ 100% Zufrieden</div>
      </div>
