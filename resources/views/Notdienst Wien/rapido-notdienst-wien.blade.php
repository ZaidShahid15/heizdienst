  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner">
      ...
      <p class="wolf-hero__sub">
        Professioneller Rapido Kundendienst Wien für Gasgeräte, Thermen und Heizsysteme inklusive Wartung, Reparaturen und Notdienst.
      </p>

      <div class="wolf-hero__logo">
        <img src="{{ asset('img/1rapido.jpeg') }}" alt="Rapido Kundendienst Wien" loading="lazy" decoding="async">
      </div>
        ...
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              ...
              im Umgang mit Rapido Heizungen und Thermen. Jeder Techniker arbeitet nach hohen Qualitätsstandards.
            </p>
            <p>
    ...
    <div class="service-container">
      ...
      <div class="service-grid service-grid--2">
        <article class="service-feature">
          ...
          <div>
            <h3>Rapido Gasgeräte Service</h3>
            <p>Service für Rapido Gasgeräte inklusive Überprüfung, Wartung und sicherer Funktion im gesamten Zuhause.</p>
          </div>
        </article>
      ...
      <div class="card-split">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Eine regelmäßige Thermenwartung ist entscheidend für Funktion, Sicherheit und Langlebigkeit Ihrer Rapido Geräte.
  ...
  <section class="service-section service-section--dark" id="notdienst-services">
    <div class="service-container service-emergency">
      <div class="service-emergency__text">
        <h2>Rapido Notdienst im Notfall</h2>
        <p>
        ...
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              ...
              dass die Qualität von Rapido Systemen dauerhaft erhalten bleibt.
            </p>
          </div>
        </div>
  ...
  <section class="service-section" id="faq-services">
    <div class="service-container">
      ...
      <div class="service-faq">
        <details>
          <summary>Was bietet der Rapido Kundendienst Wien?</summary>
        ...
        <details>
          ...
          <p>Ja, wir verwenden passende Ersatzteile und Verschleißteile für Rapido Geräte.</p>
        </details>
