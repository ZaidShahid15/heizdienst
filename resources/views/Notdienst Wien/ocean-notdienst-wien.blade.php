...
<style>
  ...
  *{box-sizing:border-box}
  ...
  /* Image box (✅ equal to content height) */
  ...
  .promo-banner__title{margin:0; color:#09383F;}
  .promo-banner__price{margin:0; color:#09383F;}
  .promo-banner__btn{
    display:inline-flex;
    align-items:center;
    justify-content:center;
  ...
  @media (max-width: 980px){
    ...
    .service-media__box{height:220px;} /* ✅ keep good mobile height */
  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner">
      ...
      <p class="wolf-hero__sub">
        Professioneller Ocean Kundendienst Wien für Gasgeräte, Thermen und Heizsysteme inklusive Wartung, Reparaturen und Notdienst.
      </p>

      <div class="wolf-hero__logo">
        <img src="{{ asset('img/1oceanbaxi.jpeg') }}" alt="Ocean Kundendienst Wien" loading="lazy" decoding="async">
      </div>
      ...
      <section class="promo-banner" id="wolf-aktion">
        <div class="promo-banner__inner">
          <div class="promo-banner__content">
            <h2 class="promo-banner__title"><em>Ocean Kundendienst Aktion</em></h2>
      ...
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/oceanbaxi.jpeg') }}" alt="Ocean Service in Wien" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              ...
              im Umgang mit Ocean Heizungen und Thermen. Jeder Techniker arbeitet nach hohen Qualitätsstandards.
            </p>
            <p>
      ...
      <div class="service-grid service-grid--2">
        <article class="service-feature">
          ...
          <div>
            ...
            <p>Service für Ocean Gasgeräte inklusive Überprüfung, Wartung und sicherer Funktion im gesamten Zuhause.</p>
          </div>
        </article>
      ...
      <div class="card-split">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Eine regelmäßige Thermenwartung ist entscheidend für Funktion, Sicherheit und Langlebigkeit Ihrer Ocean Geräte.
  ...
  <section class="service-section service-section--dark" id="notdienst-services">
    <div class="service-container service-emergency">
      <div class="service-emergency__text">
        <h2>Ocean Notdienst im Notfall</h2>
        <p>
  ...
  <section class="service-section" id="preise-services">
    <div class="service-container">
      <div class="card-split">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              ...
              dass die Qualität von Ocean Systemen dauerhaft erhalten bleibt.
            </p>
          </div>
        </div>
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-4.jpg') }}" alt="Kosten & Vorteile" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="service-section" id="faq-services">
    <div class="service-container">
      ...
      <div class="service-faq">
        <details>
          <summary>Was bietet der Ocean Kundendienst Wien?</summary>
        ...
        <details>
          ...
          <p>Ja, wir verwenden passende Ersatzteile und Verschleißteile für Ocean Geräte.</p>
        </details>
