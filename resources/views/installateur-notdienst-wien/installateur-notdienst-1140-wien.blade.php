...
$metaDescription = "Installateur Notdienst 1140 Wien – schneller Installateur Wien 1140 für Sanitär, Gas und Heizung. Soforthilfe bei Rohrbruch, Abfluss verstopft oder Heizung defekt.";
@endphp
    ...
    <section class="wolf-hero" id="hero-services">
        <div class="wolf-hero__inner container">
            <h1>
                ...
                <span style="color:#FB9A1B;">24h schnell & zuverlässig in Penzing</span>
            </h1>

            <p class="wolf-hero__sub">
                Rohrbruch, verstopfter Abfluss oder Heizungsausfall? Unser Installateur Notdienst 1140 Wien ist rund um die Uhr für Sie da. Als lokaler Fachbetrieb in Penzing garantieren wir kurze Anfahrtswege, schnelle Hilfe und transparente Preise. Ob Gas, Wasser oder Heizung – wir lösen Ihr Problem noch heute.
            </p>
            ...
            <div class="card-split">
                <div class="card-split__text">
                    <div class="card-box">
                        ...
                        <p>Wenn bei Ihnen zuhause oder im Betrieb das Wasser aus der Wand schießt, die Heizung streikt oder der Abfluss nicht mehr abläuft, zählt jede Minute. Unser Installateur Notdienst in 1140 Wien ist speziell für solche Notfälle organisiert: Wir sind 24 Stunden am Tag, 7 Tage die Woche erreichbar und kommen sofort zu Ihnen nach Penzing. Durch unsere lokale Verankerung vermeiden wir lange Anfahrtszeiten – meist sind wir in unter 30 Minuten vor Ort. Mit modernster Technik und langjähriger Erfahrung beheben wir das Problem schnell und nachhaltig, damit Sie wieder Ruhe haben. Weitere Details finden Sie in unseren <a href="{{ route('installateur-notdienst-1130-wien') }}">weiterführenden Informationen</a>.</p>
                    </div>
                </div>
            ...
            <div class="service-grid service-grid--2" style="margin-top:14px">
                ...
                <article class="service-feature">
                    ...
                    <div>
                        ...
                        <p>Durch unseren Standort im 14. Bezirk sind wir garantiert schneller als überregionale Anbieter. Sie profitieren von kurzen Wegen.</p>
                    </div>
                </article>
                <article class="service-feature">
                    <div class="service-feature__icon" aria-hidden="true">???</div>
    ...
    <section class="service-section" id="leistungen-services">
        <div class="container">
            <div class="service-section__head">
                <h2>Unsere Leistungen für Sie in Penzing</h2>
            ...
            <div class="card-split card-split--reverse">
                <div class="card-split__text">
                    <div class="card-box">
                        ...
                        <p>Wenn die Heizung nicht zündet, die Spülung läuft oder der Boiler tropft, ist schnelle Hilfe gefragt. Unser Installateur Notdienst in 1140 diagnostiziert den Fehler meist direkt vor Ort und hat die gängigsten Ersatzteile bereits im Fahrzeug dabei. So können wir viele Reparaturen sofort erledigen – ohne zweiten Termin. Sollte doch ein Spezialteil nötig sein, organisieren wir es schnellstmöglich und halten Sie über den Fortschritt auf dem Laufenden. Wir arbeiten markenunabhängig und kennen die typischen Schwachstellen aller gängigen Fabrikate.</p>
                    </div>
                </div>
                <div class="card-split__media">
                    <div class="service-media__box">
        ...
        <div class="container service-emergency">
            ...
            <div class="service-emergency__panel">
                <div class="service-panel">
                    <h3>Typische Notfälle in 1140</h3>
