...
$metaDescription = "Installateur Notdienst 1230 Wien – schneller Installateur Wien 1230 für Gas, Wasser und Heizung. Soforthilfe bei Rohrbruch, Thermenproblemen oder verstopften Abflüssen.";
@endphp
    ...
    <section class="wolf-hero" id="hero-services">
        <div class="wolf-hero__inner container">
            <h1>
                ...
                <span style="color:#FB9A1B;">24h schnell & zuverlässig in Liesing</span>
            </h1>

            <p class="wolf-hero__sub">
                Rohrbruch, verstopfter Abfluss oder Heizungsausfall? Unser Installateur Notdienst 1230 Wien ist rund um die Uhr für Sie da. Als lokaler Fachbetrieb in Liesing garantieren wir kurze Anfahrtswege, schnelle Hilfe und transparente Preise. Ob Gas, Wasser oder Heizung – wir lösen Ihr Problem noch heute.
            </p>
            ...
            <div class="card-split">
                <div class="card-split__text">
                    <div class="card-box">
                        ...
                        <p>Wenn bei Ihnen in Liesing das Wasser aus der Wand schießt, die Heizung streikt oder der Abfluss verstopft ist, zählt jede Minute. Unser Installateur Notdienst in 1230 Wien ist speziell für <a href="{{ route('installateur-notdienst-1220-wien') }}">solche Notfälle</a> organisiert: Wir sind 24 Stunden am Tag, 7 Tage die Woche erreichbar und kommen sofort zu Ihnen – ob in Atzgersdorf, Erlaa, Mauer, Rodaun oder Siebenhirten. Durch unsere lokale Verankerung vermeiden wir lange Anfahrtszeiten – meist sind wir in unter 30 Minuten vor Ort. Mit modernster Technik und langjähriger Erfahrung beheben wir das Problem schnell und nachhaltig, damit Sie wieder Ruhe haben.</p>
                    </div>
                </div>
                <div class="card-split__media">
                    <div class="service-media__box">
                        <img class="service-media__img" src="img/1size6.jpeg" alt="Installateur Notdienst 1230 Wien im Einsatz" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
            ...
            <div class="service-grid service-grid--2" style="margin-top:14px">
                ...
                <article class="service-feature">
                    ...
                    <div>
                        ...
                        <p>Durch unseren Standort im 23. Bezirk sind wir garantiert schneller als überregionale Anbieter. Sie profitieren von kurzen Wegen.</p>
                    </div>
                </article>
                <article class="service-feature">
                    <div class="service-feature__icon" aria-hidden="true">🛠️</div>
    ...
    <section class="service-section" id="team-services">
        <div class="container">
            <div class="card-split card-split--reverse">
                <div class="card-split__text">
                    <div class="card-box">
                        <h2>Unser Team – Ihr verlässlicher Partner in 1230</h2>
                        <p>Hinter unserem Installateur Notdienst steht ein eingespieltes Team aus geprüften Fachkräften. Wir bilden uns regelmäßig weiter, um stets auf dem neuesten Stand der Technik zu sein. Viele unserer Kunden in Liesing – von der Altmannsdorfer Straße über den Liesinger Platz bis nach Kalksburg – schätzen besonders unsere Zuverlässigkeit und die ruhige, sachliche Art, mit der wir auch in hektischen Notfallsituationen den Überblick behalten. Wir arbeiten sauber, hinterlassen keine Unordnung und erklären Ihnen verständlich, was passiert ist und wie wir es beheben. So gewinnen wir nicht nur Ihr Vertrauen, sondern oft auch langfristige Kundenbeziehungen.</p>
                ...
                <div class="card-split__media">
                    <div class="service-media__box">
                        <img class="service-media__img" src="img/1size5.jpeg" alt="Installateur Team in Wien 1230" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="service-section" id="leistungen-services">
        <div class="container">
            <div class="service-section__head">
                <h2>Unsere Leistungen für Sie in Liesing</h2>
    ...
    <section class="service-section service-section--soft" id="wartung-services">
        <div class="container">
            <div class="card-split">
                ...
                <div class="card-split__media">
                    <div class="service-media__box">
                        <img class="service-media__img" src="img/1size7.jpeg" alt="Heizungswartung in 1230 Wien" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-split card-split--reverse">
                <div class="card-split__text">
                    <div class="card-box">
                        ...
                        <p>Wenn die Heizung nicht zündet, die Spülung läuft oder der Boiler tropft, ist schnelle Hilfe gefragt. Unser Installateur Notdienst in 1230 diagnostiziert den Fehler meist direkt vor Ort und hat die gängigsten Ersatzteile bereits im Fahrzeug dabei. So können wir viele Reparaturen sofort erledigen – ohne zweiten Termin. Sollte doch ein Spezialteil nötig sein, organisieren wir es schnellstmöglich und halten Sie über den Fortschritt auf dem Laufenden. Wir arbeiten markenunabhängig und kennen die typischen Schwachstellen aller gängigen Fabrikate.</p>
                    </div>
                </div>
                <div class="card-split__media">
                    <div class="service-media__box">
                        <img class="service-media__img" src="img/1size4.jpeg" alt="Reparatur durch Installateur 1230" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container service-emergency">
            ...
            <div class="service-emergency__panel">
                <div class="service-panel">
                    <h3>Typische Notfälle in 1230</h3>
