            ...
            <div class="card-split">
                <div class="card-split__text">
                    <div class="card-box">
                        ...
                        <p>Wenn bei Ihnen in Hernals das Wasser aus der Wand schießt, die Heizung streikt oder der Abfluss verstopft ist, zählt jede Minute. Unser Installateur Notdienst in 1170 Wien ist speziell für solche Notfälle organisiert: Wir sind 24 Stunden am Tag, 7 Tage die Woche erreichbar und kommen sofort zu Ihnen nach Hernals. Durch unsere lokale Verankerung vermeiden wir lange Anfahrtszeiten – meist sind wir in unter 30 Minuten vor Ort. Mit modernster Technik und langjähriger Erfahrung beheben wir das Problem schnell und nachhaltig, damit Sie wieder Ruhe haben. Weitere Details finden Sie in unseren <a href="{{ route('installateur-notdienst-1160-wien') }}">weiterführenden Informationen</a>.</p>
                    </div>
                </div>
