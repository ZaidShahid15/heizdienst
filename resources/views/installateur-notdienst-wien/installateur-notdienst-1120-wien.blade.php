@extends('layout.app')
    ...
    $metaDescription = "Installateur 1120 Wien (Meidling) f�r Heizung, Warmwasser, Wartung, Reparatur und Notdienst. Schnelle Hilfe, klare Preise, saubere Ausf�hrung.";
    @endphp
...
<main>
  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner container">
      ...
      <p class="wolf-hero__sub">Als Installateur in 1120 Wien (Meidling) unterst�tzen wir Sie bei allen Aufgaben rund um Heizung, Warmwasser und moderne Haustechnik. Von der planbaren Wartung �ber die schnelle St�rungsbehebung bis hin zu Reparaturen und Modernisierung erhalten Sie strukturierte Abl�ufe, verst�ndliche Erkl�rungen und eine saubere Ausf�hrung. Wir achten auf Sicherheit, Effizienz und langfristige Zuverl�ssigkeit � besonders wichtig bei Anlagen, die t�glich laufen. Durch kurze Wege im Bezirk 1120 reagieren wir flexibel, koordinieren Termine z�gig und halten Sie �ber jeden Schritt transparent informiert.</p>
    ...
    <div class="container">
      <div class="card-split">
        <div class="card-split__text"><div class="card-box">
          <h2>Installateur-Service in 1120 Wien � zuverl�ssig & strukturiert</h2>
          <p>Als Installateur in 1120 Wien (Meidling) unterst�tzen wir Sie bei allen Aufgaben rund um Heizung, Warmwasser und moderne Haustechnik. Von der planbaren Wartung �ber die schnelle St�rungsbehebung bis hin zu Reparaturen und Modernisierung erhalten Sie strukturierte Abl�ufe, verst�ndliche Erkl�rungen und eine saubere Ausf�hrung. Wir achten auf Sicherheit, Effizienz und langfristige Zuverl�ssigkeit � besonders wichtig bei Anlagen, die t�glich laufen. Durch kurze Wege im Bezirk 1120 reagieren wir flexibel, koordinieren Termine z�gig und halten Sie �ber jeden Schritt transparent informiert. Weitere Details finden Sie in unseren <a href="{{ route('installateur-notdienst-1110-wien') }}">weiterf�hrenden Informationen</a>.</p>
        </div></div>
        <div class="card-split__media"><div class="service-media__box">
          <img class="service-media__img" src="img/1size6.webp" alt="Installateur Service 1120 Wien" loading="lazy" decoding="async">
        </div></div>
      </div>
      ...
      <div class="service-grid service-grid--2" style="margin-top:14px">
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">??</div><div>
          <h3>Wartung & Pr�fung</h3><p>Regelm��ige Checks erh�hen Sicherheit, senken Verbrauch und verhindern Ausf�lle im Alltag.</p>
        </div></article>
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">?</div><div>
          <h3>Reparatur & Fehlerbehebung</h3><p>Schnelle Diagnose bei St�rungen � zielgerichtete L�sung, verst�ndlich erkl�rt und sauber umgesetzt.</p>
        </div></article>
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">?????</div><div>
          <h3>Erfahrene Fachkr�fte</h3><p>Praxiswissen und strukturierte Abl�ufe sorgen f�r stabile Ergebnisse � vom ersten Kontakt bis zur L�sung.</p>
        </div></article>
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">??</div><div>
  ...
  <section class="service-section" id="leistungen-services">
    <div class="container">
      <div class="service-section__head"><h2>Leistungen im �berblick</h2><p>Als Installateur in 1120 Wien (Meidling) unterst�tzen wir Sie bei allen Aufgaben rund um Heizung, Warmwasser und moderne Haustechnik. Von der planbaren Wartung �ber die schnelle St�rungsbehebung bis hin zu Reparaturen und Modernisierung erhalten Sie strukturierte Abl�ufe, verst�ndliche Erkl�rungen und eine saubere Ausf�hrung. Wir achten auf Sicherheit, Effizienz und langfristige Zuverl�ssigkeit � besonders wichtig bei Anlagen, die t�glich laufen. Durch kurze Wege im Bezirk 1120 reagieren wir flexibel, koordinieren Termine z�gig und halten Sie �ber jeden Schritt transparent informiert.</p></div>
      <div class="service-grid service-grid--2">
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">??</div><div><h3>Wartung</h3><p>Reinigung, Pr�fung, Einstellung und Funktionskontrolle � f�r einen sicheren, effizienten Betrieb.</p></div></article>
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">??</div><div><h3>Service & Optimierung</h3><p>Feinabstimmung, Druck-Checks und Effizienz-Optimierung � damit Ihre Anlage stabil l�uft.</p></div></article>
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">?</div><div><h3>Reparaturen</h3><p>Z�gige Fehlerdiagnose und fachgerechte Reparatur � mit Blick auf Nachhaltigkeit und Folgekosten.</p></div></article>
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">??</div><div><h3>Heizung & Warmwasser</h3><p>Unterst�tzung bei Ausfall, schwankender Temperatur oder Druckproblemen � praxisnah gel�st.</p></div></article>
        ...
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true">?</div><div><h3>Sicherheit</h3><p>Kontrolle sicherheitsrelevanter Komponenten � f�r zuverl�ssigen Betrieb und mehr Wohlbefinden.</p></div></article>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="card-split">
        <div class="card-split__text"><div class="card-box">
          ...
          <p>Als Installateur in 1120 Wien (Meidling) unterst�tzen wir Sie bei allen Aufgaben rund um Heizung, Warmwasser und moderne Haustechnik. Von der planbaren Wartung �ber die schnelle St�rungsbehebung bis hin zu Reparaturen und Modernisierung erhalten Sie strukturierte Abl�ufe, verst�ndliche Erkl�rungen und eine saubere Ausf�hrung. Wir achten auf Sicherheit, Effizienz und langfristige Zuverl�ssigkeit � besonders wichtig bei Anlagen, die t�glich laufen. Durch kurze Wege im Bezirk 1120 reagieren wir flexibel, koordinieren Termine z�gig und halten Sie �ber jeden Schritt transparent informiert. Auch beim Serviceangebot profitieren Sie von unserer strukturierten Arbeitsweise. F�r mehr Infos besuchen Sie <a href="{{ route('home') }}">Thermenwartung & Thermenservice Wien & Nieder�sterreich</a>.</p>
          <div class="service-stats">
 ...
 <a class="brand-card" href="{{ route('loeblich.thermentausch') }}">
  ...
  <section class="service-section" id="faq-services">
    <div class="container">
      <div class="service-section__head"><h2>FAQ � Installateur 1120 Wien</h2><p>Antworten auf die h�ufigsten Fragen � kurz, klar und praxisnah.</p></div>
      <div class="service-faq"><details>
          <summary>1. Wie schnell sind Sie in meinem Bezirk vor Ort?</summary>
          <p>In der Regel erreichen wir Sie je nach Verkehrslage innerhalb kurzer Zeit. F�r 1120 Wien planen wir Eins�tze so, dass Anfahrt, Diagnose und erste Ma�nahmen effizient ablaufen.</p>
        </details>
        <details>
          <summary>2. Bieten Sie Installateur-Notdienst in 1120 Wien an?</summary>
          <p>Ja. Bei Ausf�llen von Heizung, Warmwasser oder sicherheitsrelevanten Auff�lligkeiten helfen wir auch au�erhalb der �blichen Zeiten.</p>
        </details>
        <details>
          <summary>3. Welche Leistungen umfasst eine Wartung?</summary>
          <p>Wir pr�fen Ger�tezustand, reinigen relevante Komponenten, kontrollieren Sicherheitseinrichtungen und optimieren Einstellungen � f�r stabilen Betrieb und geringeren Verbrauch.</p>
        </details>
        <details>
          <summary>4. Reparieren Sie auch �ltere Anlagen?</summary>
          <p>Ja, sofern Ersatzteile verf�gbar sind. Wir beurteilen Wirtschaftlichkeit und beraten transparent, ob Reparatur oder Austausch sinnvoller ist.</p>
        </details>
        <details>
          <summary>5. Gibt es transparente Preise?</summary>
          <p>Vor Ort erhalten Sie eine klare Einsch�tzung der Arbeiten. Bei planbaren Leistungen nennen wir Richtwerte und erkl�ren die Kostentreiber verst�ndlich.</p>
        </details>
        <details>
          <summary>6. Kann ich einen Termin online anfragen?</summary>
          <p>Ja. Nutzen Sie das Formular im Kontaktbereich. Wir melden uns zeitnah zur Terminbest�tigung.</p>
        </details>
        <details>
          <summary>7. Arbeiten Sie sauber und dokumentiert?</summary>
          <p>Ja. Wir sch�tzen den Arbeitsbereich, arbeiten nachvollziehbar und dokumentieren die wichtigsten Schritte � hilfreich f�r sp�tere Wartungen.</p>
        </details>
        <details>
          <summary>8. Welche Marken und Systeme betreuen Sie?</summary>
          <p>Wir betreuen g�ngige Heizungs- und Warmwassersysteme und kennen typische Fehlerbilder. Fragen Sie gern nach Ihrer konkreten Anlage.</p>
        </details>
        <details>
          <summary>9. Wie kann ich St�rungen vorbeugen?</summary>
          <p>Regelm��ige Wartung, korrekte Druckeinstellungen und das rechtzeitige Reagieren auf Fehlermeldungen reduzieren Ausf�lle deutlich.</p>
        </details>
        <details>
          <summary>10. Was brauche ich f�r den Einsatz?</summary>
          <p>Hilfreich sind Ger�tedaten (Typenschild), letzte Wartungsunterlagen und eine kurze Beschreibung der Symptome. Das beschleunigt Diagnose und L�sung.</p>
        </details>
      </div>
    </div>
  </section>
