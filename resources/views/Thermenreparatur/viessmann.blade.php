...
<main>
  ...
  <section class="service-cta" id="kontakt-services">
    <div class="service-container service-cta__inner">
      <div>
        <h2>Jetzt Viessmann Thermenservice in Wien sichern</h2>
        <p>
          Ob Viessmann Thermenreparatur Wien, Viessmann Thermenwartung oder schneller Notdienst – wir sind Ihr Fachmann für zuverlässige Heizsysteme.
          Unser Service steht Ihnen telefonisch oder per Terminvergabe jederzeit zur Verfügung.
        </p>
        <p style="margin-top:10px;">
          Kontaktieren Sie uns jetzt und sichern Sie sich professionelle Betreuung, transparente Kostenstruktur und maximale Sicherheit für Ihr Zuhause.
        </p>
      </div>
