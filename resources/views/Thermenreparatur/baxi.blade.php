...
<main>
      ...
      <section class="promo-banner" id="baxi-aktion">
        <div class="promo-banner__inner">
          <div class="promo-banner__content">
            ...
            <a class="promo-banner__btn" href="tel:+4369981243996" aria-label="Anrufen">
              ANRUFEN
            </a>
          </div>
        </div>
  ...
  <section class="service-cta" id="kontakt-services">
    <div class="service-container service-cta__inner">
      <div>
        <h2>Jetzt Baxi Thermenservice in Wien sichern</h2>
        <p>
          Ob Baxi Thermenreparatur Wien, Baxi Thermenwartung oder schneller Notdienst – wir sind Ihr kompetenter Ansprechpartner für alle Anliegen rund um Ihre Baxi Therme.
          Unser Team steht Ihnen rund um die Uhr zur Verfügung und sorgt für fachgerechte Reparaturen, sichere Installation und nachhaltige Effizienz.
        </p>
        <p style="margin-top:10px;">
          Kontaktieren Sie uns über diese Seite oder vereinbaren Sie direkt einen Termin.
          Wir garantieren transparente Preise, hohe Qualität und langfristige Zuverlässigkeit für Ihre Heizungsanlage.
        </p>
      </div>
      ...
      <form class="service-cta__form" action="#" method="post">
        ...
        <label style="margin-top:10px;">
          <span>Nachricht</span>
          <textarea name="message" rows="4" placeholder="Modell/Gerät, Störung, Ort, Wunschzeit..." required></textarea>
        </label>
