...
<style>
    ...
    *{box-sizing:border-box}
    ...
    /* =========================
       IMAGE BOX (UPDATED)
       - except hero section
       - parent: width 100%, height 230px
       - image: width 100%, height 100%
       - image shows fully (no crop) => object-fit: contain
       ========================= */
    .service-media{
      width:100%;
    }
    .service-media__box{
      ...
      overflow:hidden;
      background: var(--muted); /* shows behind image if contain adds empty space */
    }
    .service-media__img{
      width:100%;
      height:100%;
...
<main>
    ...
    <section class="service-section" id="warum-services">
        <div class="service-container service-split">
            ...
            <!-- UPDATED: image now uses img tag inside fixed 230px box -->
            <div class="service-split__media service-media">
                <div class="service-media__box">
                    <img
                        class="service-media__img"
                        src="img/final.png"
                        alt="Vaillant Gerät / Wartung"
                        loading="lazy"
                        decoding="async"
                    />
                </div>
