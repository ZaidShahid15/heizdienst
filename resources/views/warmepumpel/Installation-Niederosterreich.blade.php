...
<section class="toc-wrap" aria-label="Inhaltsverzeichnis">
  ...
  <section class="service-section" id="effizient-heizen">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Eine Wärmepumpe ist in Niederösterreich eine nachhaltige Heizlösung für Haushalte im Neubau, Altbau oder bei einer Sanierung.</p>
      </div>
    ...
    <div class="service-container service-split">
      ...
      <div class="service-split__media">
        <div class="service-media__box">
          <img class="service-media__img" src="{{ asset('img/waermepumpe-planung.jpg') }}" alt="Wärmepumpen Planung" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/600x400'"/>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="luftwaermepumpe-systeme">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Die Luftwärmepumpe ist in Niederösterreich besonders gefragt, da sie ohne aufwendige Erdarbeiten auskommt und flexibel einsetzbar ist.</p>
      </div>
  ...
  <section class="service-section service-section--soft" id="foerderungen">
    <div class="service-container service-split service-split--reverse">
      ...
      <div class="service-split__media">
        <div class="service-media__box">
          <img class="service-media__img" src="{{ asset('img/foerderung-noe.jpg') }}" alt="Förderung Niederösterreich" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/600x400'"/>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="regionen">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Ob im Raum Wien, in Wiener Neustadt, Wolkersdorf oder Gänserndorf – in ganz Niederösterreich steigt die Nachfrage nach moderner Heiztechnik.</p>
      </div>
  ...
  <section class="service-section" id="faq-services">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Die wichtigsten Antworten rund um Installation, Förderung und Betrieb.</p>
      </div>
