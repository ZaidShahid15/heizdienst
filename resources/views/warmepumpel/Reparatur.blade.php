...
<section class="toc-wrap" aria-label="Inhaltsverzeichnis">
  ...
  <section class="service-section" id="service-ueberblick">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Unser wärmepumpen service in Wien richtet sich an private und gewerbliche Kunden, die eine zuverlässige Lösung für ihre wärmepumpe suchen.</p>
      </div>
    ...
    <div class="service-container service-split">
      ...
      <div class="service-split__media">
        <div class="service-media__box">
          <img class="service-media__img" src="{{ asset('img/waermepumpe-reparatur.jpg') }}" alt="Wärmepumpen Reparatur Wien" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/600x400'"/>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="systeme">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Moderne Wärmepumpensysteme bieten effiziente Heizlösungen für unterschiedliche Umgebungen in Wien und Niederösterreich.</p>
      </div>
  ...
  <section class="service-section service-section--soft" id="installation">
    <div class="service-container service-split service-split--reverse">
      ...
      <div class="service-split__media">
        <div class="service-media__box">
          <img class="service-media__img" src="{{ asset('img/waermepumpe-installation.jpg') }}" alt="Wärmepumpen Installation Wien" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/600x400'"/>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="fachbetrieb">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Als erfahrener Fachbetrieb verbinden wir technisches Know-how mit persönlicher Betreuung.</p>
      </div>
