...
<section class="toc-wrap" aria-label="Inhaltsverzeichnis">
    ...
    <div class="service-container service-split">
      ...
      <div class="service-split__media">
        <div class="service-media__box">
          <img class="service-media__img" src="{{ asset('img/1size9.webp') }}" alt="Wärmepumpen Installation Wien" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/600x400'"/>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section service-section--soft" id="foerderung-services">
    <div class="service-container service-split service-split--reverse">
      ...
      <div class="service-split__media">
        <div class="service-media__box">
          <img class="service-media__img" src="{{ asset('img/1size10.webp') }}" alt="Förderung für Wärmepumpen in Wien" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/600x400'"/>
        </div>
      </div>
    </div>
  </section>
