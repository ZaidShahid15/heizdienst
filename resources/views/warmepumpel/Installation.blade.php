...
<section class="toc-wrap" aria-label="Inhaltsverzeichnis">
  ...
  <section class="service-section" id="vorteile-services">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Nachhaltige Energie, niedrige Betriebskosten und aktiver Klimaschutz.</p>
      </div>
  ...
  <section class="service-section" id="systeme-services">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Je nach Gebäude und Umgebung kommen unterschiedliche Wärmepumpen Systeme zum Einsatz.</p>
      </div>
  ...
  <section class="service-section service-section--soft" id="foerderung-services">
    <div class="service-container service-split service-split--reverse">
      ...
      <div class="service-split__media">
        <div class="service-media__box">
          <img class="service-media__img" src="{{ asset('img/foerderung-wien.jpg') }}" alt="Förderung für Wärmepumpen in Wien" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/600x400'"/>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="umgebung-services">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Nicht nur in der Stadt Wien, sondern auch in der Umgebung und in Niederösterreich ist die Installation von Wärmepumpen stark gefragt.</p>
      </div>
  ...
  <section class="service-section" id="faq-services">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Die wichtigsten Antworten rund um die Wärmepumpe.</p>
      </div>
