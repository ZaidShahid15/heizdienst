...
<section class="toc-wrap" aria-label="Inhaltsverzeichnis">
  ...
  <section class="service-section" id="service-noe">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Unser Wärmepumpen Service in Niederösterreich betreut private Haushalte, Unternehmen und Gewerbebetriebe in der gesamten Region.</p>
      </div>
  ...
  <section class="service-section" id="moderne-systeme">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Moderne Wärmepumpen bieten nachhaltige Lösungen für Heizung und Kühlung in Niederösterreich.</p>
      </div>
  ...
  <section class="service-section service-section--soft" id="installation-einbau">
    <div class="service-container service-split service-split--reverse">
      ...
      <div class="service-split__media">
        <div class="service-media__box">
          <img class="service-media__img" src="{{ asset('img/waermepumpe-installation.jpg') }}" alt="Wärmepumpen Installation" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/600x400'"/>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="einsatzgebiet">
    <div class="service-container">
      <div class="service-section__head">
        ...
        <p>Unser Servicegebiet umfasst ganz Niederösterreich sowie angrenzende Regionen in Wien.</p>
      </div>
