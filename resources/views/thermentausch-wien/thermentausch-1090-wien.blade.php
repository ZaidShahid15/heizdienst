  ...
  <section class="service-section" id="leistungen-services">
    <div class="container">
      ...
      <div class="service-grid service-grid--2">
        ...
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true"><i class="bi bi-tools"></i></div><div><h3>Austausch alter Gasthermen in Wien 1090</h3><p>Speziell für Alsergrund: Wir ersetzen veraltete Geräte durch zeitgemäße Heiztechnik.</p></div></article>
