...
<main>
    ...
    <div class="container">
      <div class="card-split">
        ...
        <div class="card-split__media"><div class="service-media__box">
          <img class="service-media__img" src="img/1size6.webp" alt="Thermentausch 1050 Wien" loading="lazy" decoding="async">
        </div></div>
      </div>
  ...
  <section class="service-section" id="team-services">
    <div class="container">
      <div class="card-split card-split--reverse">
        ...
        <div class="card-split__media"><div class="service-media__box">
          <img class="service-media__img" src="img/1size5.webp" alt="Installateur Team 1050 Wien" loading="lazy" decoding="async">
        </div></div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="leistungen-services">
    <div class="container">
      ...
      <div class="service-grid service-grid--2">
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true"><i class="bi bi-tools"></i></div><div><h3>Professioneller Thermentausch 1050 Wien</h3><p>Kompletter Austausch Ihrer alten Gastherme gegen ein modernes, effizientes Gerät – fachgerecht und schnell.</p></div></article>
        ...
        <article class="service-feature"><div class="service-feature__icon" aria-hidden="true"><i class="bi bi-fire"></i></div><div><h3>Austausch alter Gasthermen</h3><p>Speziell für Margareten: Wir ersetzen veraltete Geräte durch zeitgemäße Heiztechnik.</p></div></article>
  ...
  <section class="service-section service-section--soft" id="ablauf-services">
    <div class="container">
      <div class="card-split">
        ...
        <div class="card-split__media"><div class="service-media__box">
          <img class="service-media__img" src="img/1size7.webp" alt="Ablauf Thermentausch 1050 Wien" loading="lazy" decoding="async">
        </div></div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="reparatur-services">
    <div class="container">
      <div class="card-split card-split--reverse">
        ...
        <div class="card-split__media"><div class="service-media__box">
          <img class="service-media__img" src="img/1size4.webp" alt="Thermenwartung 1050 Wien" loading="lazy" decoding="async">
        </div></div>
      </div>
    </div>
  </section>
  ...
  <section class="service-section" id="preise-services">
    <div class="container">
      <div class="card-split">
        <div class="card-split__media"><div class="service-media__box">
          <img class="service-media__img" src="img/1size2.jpegs.webp" alt="Kosten Thermentausch 1050 Wien" loading="lazy" decoding="async">
        </div></div>
        <div class="card-split__text"><div class="card-box">
