  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner">
      ...
      <div class="wolf-hero__logo">
        <img src="{{ asset('img/vaillant1-1.jpg') }}" alt="Vaillant Installateur Wien" loading="lazy" decoding="async">
      </div>
      ...
      <div class="wolf-hero__actions">
        <a class="wolf-btn wolf-btn--accent" href="#kontakt-services">Jetzt Termin anfragen</a>
      ...
      <section class="promo-banner" id="vaillant-aktion">
        <div class="promo-banner__inner">
          <div class="promo-banner__content">
            <h2 class="promo-banner__title"><em>Faire Preise</em></h2>
            <p class="promo-banner__price"><strong>inkl. MwSt</strong></p>
