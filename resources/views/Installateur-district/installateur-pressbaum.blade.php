      ...
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/1size1.jpeg') }}" alt="Installateur Pressbaum Team" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="service-section service-section--soft" id="region-services">
    <div class="service-container">
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-6.jpg') }}" alt="Pressbaum und Umgebung" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
