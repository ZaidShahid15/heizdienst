...
@php
$metaTitle = "Installateur Purkersdorf | Sanitär, Heizung & Notdienst Service";
$metaDescription = "Installateur Purkersdorf für Sanitär, Heizung, Rohrreinigung und Reparatur. Schneller Service in Purkersdorf Niederösterreich und Umgebung. Jetzt anrufen oder E-Mail senden.";
@endphp
...
<main>
  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner container">
      ...
      <p class="wolf-hero__sub">
        Ihr Installateur Purkersdorf bietet schnellen und zuverlässigen Service für Sanitär, Heizung und moderne Installationen. Unser Team unterstützt Haushalte und Betriebe professionell in Purkersdorf.
      </p>
      ...
      <div class="toc-card" id="tocCard">
        ...
        <div class="toc-body" id="tocBody">
          <ul class="toc-list" id="tocList">
            ...
            <li class="toc-item"><a href="#region-services" class="toc-link"><span class="toc-badge">06</span><span class="toc-text">Purkersdorf & Umgebung</span></a></li>
  ...
  <!-- Professioneller Installateur Service in Purkersdorf -->
      ...
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/1size1.webp') }}" alt="Installateur Purkersdorf Team" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="service-container">
      ...
      <div class="service-grid service-grid--2">
        <article class="service-feature">
          ...
          <div>
            <h3>Moderne Sanitärarbeiten und Bad Installation in Purkersdorf</h3>
            <p>Unser Installateur übernimmt professionelle Sanitär Arbeiten sowie jede Bad Installation in Purkersdorf. Wir planen funktionale Badezimmer und führen alle Installationen zuverlässig durch. Durch moderne Technik und präzise Arbeiten bleiben Ihre Sanitär Anlagen langfristig sicher und komfortabel.</p>
          </div>
        </article>
        ...
        <article class="service-feature">
          <div class="service-feature__icon" aria-hidden="true">🔥</div>
          <div>
            <h3>Effiziente Heizungsanlagen für Gebäude in Purkersdorf</h3>
            <p>Eine moderne Heizungsanlage sorgt für angenehme Wärme und geringere Energiekosten. Unser Installateur plant passende Heizung Lösungen für Häuser und Wohnungen in Purkersdorf Niederösterreich. Mit moderner Technik und Erfahrung findet unser Team die passende Heizungsanlage für jedes Gebäude.</p>
          </div>
        </article>
        ...
        <article class="service-feature">
          <div class="service-feature__icon" aria-hidden="true">⚡</div>
          <div>
            <h3>Schnelle Hilfe durch unseren Installateur Notdienst in Purkersdorf</h3>
            <p>Bei Rohrbruch, austretendem Wasser oder anderen Notfällen hilft unser Installateur Purkersdorf schnell und zuverlässig – auch außerhalb der Geschäftszeiten.</p>
          </div>
        </article>
        ...
        <div class="card-split__text">
          <div class="card-box">
            ...
            <div class="service-stats">
              ...
              <div class="service-stat"><div class="service-stat__num">✓</div><div class="service-stat__label">zuverlässiger Service in Purkersdorf und Umgebung</div></div>
            </div>
          </div>
        </div>
      ...
      <div class="card-split card-split--reverse">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Der Ablauf bei unserem Installateur Purkersdorf ist klar strukturiert und kundenorientiert.
              Nach Ihrer Kontaktaufnahme über diese Seite vereinbaren wir rasch einen Termin für Purkersdorf und Umgebung.
            </p>
            <p>
  ...
  <section class="service-section service-section--soft" id="region-services">
    <div class="service-container">
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-6.webp') }}" alt="Purkersdorf und Umgebung" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card-split__text">
          <div class="card-box">
            ...
            <div class="service-stats">
              ...
              <div class="service-stat"><div class="service-stat__num">✓</div><div class="service-stat__label">zuverlässiger Installateur Purkersdorf</div></div>
            </div>
          </div>
        </div>
      ...
      <div class="card-split">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Ein Rohrbruch oder ein anderes Problem mit Wasser kann jederzeit auftreten. In solchen Situationen hilft unser Installateur Purkersdorf schnell und zuverlässig. Unser Installateur Notdienst steht bei dringenden Fällen bereit und sorgt dafür, dass größere Schäden vermieden werden. Besonders bei einem Rohrbruch oder einer defekten Heizung ist schnelles Handeln wichtig.
            </p>
            <p>
              Unser Gas Wasser Installateur kennt sich mit allen wichtigen Systemen aus und führt eine fachgerechte Reparatur oder Rohrreinigung durch. Viele Kunden in Purkersdorf und der Umgebung vertrauen unserem schnellen Service. Wenn Sie einen Installateur Purkersdorf Umgebung benötigen, erhalten Sie professionelle Unterstützung von unserem erfahrenen Team.
            </p>
          </div>
        </div>
  ...
  <section class="service-section" id="faq-services">
    <div class="service-container">
      <div class="service-section__head">
        <h2>Häufige Fragen zu unserem Installateur in Purkersdorf</h2>
      ...
      <div class="service-faq">
        <details>
          ...
          <p>Unser Installateur Purkersdorf bietet einen zuverlässigen Notdienst bei dringenden Problemen. In vielen Fällen sind wir schnell erreichbar und helfen auch außerhalb der üblichen Uhr-Zeiten.</p>
        </details>
        ...
        <details>
          <summary>Arbeiten Sie auch in der Umgebung von Purkersdorf?</summary>
          <p>Ja, unser Installateur arbeitet in Purkersdorf Niederösterreich sowie in der gesamten Umgebung und unterstützt Kunden auch in nahegelegenen Orten.</p>
        </details>
        ...
        <details>
          ...
          <p>Bei einem Rohrbruch reagiert unser Installateur Purkersdorf schnell. Unser Service sorgt dafür, dass austretendes Wasser rasch gestoppt wird und größere Schäden vermieden werden.</p>
        </details>
      </div>
    </div>
  </section>
  ...
  @include('layout.contact', [
    ...
    'text' => 'Rufen Sie uns an oder senden Sie uns eine E-Mail. Ihr zuverlässiger Installateur in Purkersdorf – für Sanitär, Heizung und Notfälle.',
