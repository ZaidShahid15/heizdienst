...
@php
$metaTitle = "Installateur Hornstein | Sanitär, Heizung & Notdienst Service";
$metaDescription = "Installateur Hornstein für Sanitär, Heizung, Rohrreinigung und Notdienst. Schneller Service in Hornstein und Burgenland. Jetzt anrufen oder E-Mail senden.";
@endphp
...
<main>
  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner container">
      ...
      <p class="wolf-hero__sub">
        ...
        Professioneller Service für Haushalte und Betriebe in Hornstein und Umgebung.
      </p>
      ...
      <div class="toc-card" id="tocCard">
        ...
        <div class="toc-body" id="tocBody">
          <ul class="toc-list" id="tocList">
            ...
            <li class="toc-item"><a href="#region-services" class="toc-link"><span class="toc-badge">06</span><span class="toc-text">Hornstein & Umgebung</span></a></li>
  ...
  <!-- Ihr zuverlässiger Installateur in Hornstein -->
      ...
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/1size1.webp') }}" alt="Installateur Hornstein Team" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="service-grid service-grid--2">
        <article class="service-feature">
          ...
          <div>
            ...
            <p>Unser Installateur übernimmt professionelle Sanitär Lösungen sowie jede Bad Installation in Hornstein. Wir planen moderne Badezimmer, führen sichere Installationen durch und sorgen für langlebige Ergebnisse.</p>
          </div>
        </article>
        ...
        <article class="service-feature">
          ...
          <div>
            ...
            <p>Eine moderne Heizungsanlage sorgt für angenehme Wärme und spart Energie. Unser Installateur Hornstein installiert effiziente Heizung Systeme für Häuser und Wohnungen in Hornstein.</p>
          </div>
        </article>
        ...
        <article class="service-feature">
          ...
          <div>
            ...
            <p>Bei Rohrbruch, austretendem Wasser oder anderen Notfällen hilft unser Installateur Hornstein schnell und zuverlässig – auch außerhalb der Geschäftszeiten.</p>
          </div>
        </article>
        ...
        <article class="service-feature">
          ...
          <div>
            ...
            <p>Verstopfte Leitungen? Wir führen eine gründliche Rohrreinigung durch und sorgen dafür, dass Ihr System wieder reibungslos funktioniert.</p>
          </div>
        </article>
      </div>
    </div>
  ...
  <section class="service-section" id="anlage-services">
    <div class="service-container">
      <div class="card-split card-split--reverse">
        <div class="card-split__text">
          <div class="card-box">
            <h2>Heizung und Sanitär Service in Hornstein</h2>
            <p>
              Unser Installateur Hornstein bietet umfassenden Service rund um Heizung und Sanitär in Hornstein und in der gesamten Umgebung im Burgenland. Von modernen Installationen bis zur regelmäßigen Wartung sorgen wir dafür, dass Ihre Anlagen zuverlässig funktionieren. Eine gut geplante Heizungsanlage verbessert den Wohnkomfort und spart langfristig Energiekosten. Deshalb unterstützen wir unsere Kunden von der Planung bis zur Betreuung ihrer Anlagen.
            </p>
            <p>
              Als erfahrener Gas Wasser Installateur kümmern wir uns um sichere Leitungen, funktionierende Systeme und saubere Lösungen rund um Wasser. Unser Team arbeitet mit moderner Technik und sorgt dafür, dass alle Arbeiten sorgfältig durchgeführt werden. Wenn Sie einen Installateur Hornstein Burgenland suchen, erhalten Sie professionelle Unterstützung für Heizung, Sanitär und technische Anlagen in Hornstein.
            </p>
      ...
      <div class="card-split card-split--reverse">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Der Ablauf bei unserem Installateur Hornstein ist klar strukturiert und kundenorientiert.
              Nach Ihrer Kontaktaufnahme über diese Seite vereinbaren wir rasch einen Termin für Hornstein und Umgebung.
            </p>
            <p>
  ...
  <!-- Hornstein und Umgebung -->
  <section class="service-section service-section--soft" id="region-services">
    <div class="service-container">
      <div class="card-split">
        <div class="card-split__text">
          <div class="card-box">
            <h2>Installateur Arbeiten in Hornstein und Umgebung</h2>
            <p>
              Unser Installateur Hornstein unterstützt private Haushalte und Unternehmen bei wichtigen Installateur Arbeiten in Hornstein sowie in der gesamten Umgebung im Burgenland. Viele Menschen suchen einen Installateur Nähe, der schnell erreichbar ist und zuverlässig arbeitet. Genau diesen Service bieten wir.
            </p>
            <p>
              Ob neue Heizung, eine moderne Heizungsanlage, Sanitär Anlagen oder andere Installationen, unser Installateur sorgt für sichere und langlebige Lösungen. Durch moderne Technik und sorgfältige Planung können Projekte effizient umgesetzt werden. Unser Ziel ist es, jedes Problem schnell zu lösen und dauerhafte Lösungen zu schaffen. Wenn Sie einen Installateur Hornstein oder einen Installateur Hornstein Burgenland benötigen, profitieren Sie von Erfahrung, regionaler Nähe und professioneller Unterstützung.
            </p>
          </div>
        </div>
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-6.webp') }}" alt="Hornstein und Umgebung" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-split card-split--reverse">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Ein unerwarteter Rohrbruch, austretendes Wasser oder andere Schäden können schnell zu einem großen Problem werden. In solchen Fällen hilft unser Installateur Hornstein rasch und zuverlässig. Unser Notdienst steht bereit, um dringende Situationen zu lösen und größere Schäden zu vermeiden.
            </p>
            <p>
              Besonders bei einer defekten Heizungsanlage oder Problemen im Sanitär Bereich ist schnelle Hilfe wichtig. Unser erfahrener Gas Wasser Installateur prüft die Anlage sorgfältig und führt eine fachgerechte Reparatur oder Rohrreinigung durch. Mit moderner Technik und unserem zuverlässigen Service können viele Probleme rasch behoben werden. Wenn Sie einen Installateur Hornstein Burgenland oder einen Installateur Nähe Hornstein benötigen, erhalten Sie schnelle Unterstützung.
            </p>
          </div>
        </div>
  ...
  <section class="service-section service-section--soft" id="faq-services">
    <div class="service-container">
      <div class="service-section__head">
        <h2>Häufige Fragen zum Installateur Hornstein</h2>
      ...
      <div class="service-faq">
        <details>
          ...
          <p>Unser Installateur Hornstein bietet einen zuverlässigen Notdienst, der bei dringenden Problemen erreichbar ist. In vielen Fällen helfen wir schnell, auch außerhalb der üblichen Uhr-Zeiten.</p>
        </details>

        <details>
          <summary>Was kostet eine Rohrreinigung in Hornstein?</summary>
        ...
        <details>
          ...
          <p>Ja, wir übernehmen die Reparatur und Wartung jeder Heizungsanlage. Unser Installateur Hornstein sorgt dafür, dass Ihre Heizung wieder zuverlässig funktioniert.</p>
        </details>

        <details>
          <summary>Arbeiten Sie auch in der Umgebung von Hornstein?</summary>
          <p>Ja, unser Installateur arbeitet nicht nur in Hornstein, sondern auch in der gesamten Umgebung im Burgenland.</p>
        </details>

        <details>
          <summary>Übernehmen Sie Bad Installationen?</summary>
          <p>Selbstverständlich führen wir jede Bad Installation sowie alle Sanitär Arbeiten durch. Unser Installateur Hornstein sorgt für moderne und funktionale Lösungen.</p>
        </details>

        <details>
          <summary>Wie schnell kommt ein Installateur bei Rohrbruch?</summary>
          <p>Bei einem Rohrbruch reagieren wir schnell. Unser Installateur Hornstein kommt so rasch wie möglich, um Schäden durch austretendes Wasser zu begrenzen.</p>
        </details>
      </div>
    </div>
  </section>
  ...
  @include('layout.contact', [
    ...
    'text' => 'Rufen Sie uns an oder senden Sie uns eine E-Mail. Ihr zuverlässiger Installateur in Hornstein – für Sanitär, Heizung und Notfälle.',
