...
@php
$metaTitle = "Installateur St. Pölten | Sanitär, Heizung & Notdienst";
$metaDescription = "Installateur St. Pölten für Sanitär, Heizung, Rohrreinigung und Installateur Notdienst. Schneller Service in St. Pölten und Umgebung in Niederösterreich. Jetzt anrufen oder E-Mail senden.";
@endphp
...
<main>
  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner container">
      ...
      <p class="wolf-hero__sub">
        Ihr Installateur St. Pölten bietet schnellen Service für Sanitär, Heizung und Reparaturen.
        Zuverlässige Hilfe für Haushalte und Betriebe in St. Pölten und Umgebung.
      </p>
      ...
      <div class="toc-card" id="tocCard">
        ...
        <div class="toc-body" id="tocBody">
          <ul class="toc-list" id="tocList">
            ...
            <li class="toc-item"><a href="#region-services" class="toc-link"><span class="toc-badge">06</span><span class="toc-text">St. Pölten & Umgebung</span></a></li>
  ...
  <!-- Ihr zuverlässiger Installateur in St. Pölten -->
      ...
      <div class="service-grid service-grid--2">
        <article class="service-feature">
          ...
          <div>
            ...
            <p>Unser Installateur übernimmt professionelle Sanitär Lösungen und jede Bad Installation in St. Pölten. Wir planen moderne Badezimmer, führen sichere Installationen durch und sorgen für langlebige Ergebnisse.</p>
          </div>
        </article>
        ...
        <article class="service-feature">
          <div class="service-feature__icon" aria-hidden="true">🔥</div>
          <div>
            <h3>Moderne Heizungen für Ihr Zuhause</h3>
            <p>Eine moderne Heizungsanlage sorgt für effiziente Wärme und spart Energiekosten. Unser Installateur St. Pölten installiert passende Heizung Systeme für Häuser und Wohnungen in St. Pölten.</p>
          </div>
        </article>
        ...
        <article class="service-feature">
          ...
          <div>
            ...
            <p>Bei Rohrbruch, austretendem Wasser oder anderen Notfällen hilft unser Installateur St. Pölten schnell und zuverlässig – auch außerhalb der Geschäftszeiten.</p>
          </div>
        </article>
  ...
  <section class="service-section" id="anlage-services">
    <div class="service-container">
      <div class="card-split card-split--reverse">
        <div class="card-split__text">
          <div class="card-box">
            <h2>Heizung und Sanitär Service in St. Pölten</h2>
            <p>
              Unser Installateur St. Pölten bietet umfassenden Service rund um Heizung und Sanitär in St. Pölten und in der gesamten Umgebung in Niederösterreich. Von neuen Installationen bis zur regelmäßigen Wartung sorgen wir dafür, dass Ihre Anlagen zuverlässig funktionieren. Eine moderne Heizungsanlage steigert den Wohnkomfort und reduziert langfristig Energiekosten. Deshalb unterstützen wir unsere Kunden von der Planung bis zur Betreuung ihrer Systeme.
            </p>
            <p>
              Als erfahrener Gas Wasser Installateur kümmern wir uns um sichere Leitungen und funktionierende Anlagen rund um Wasser. Unser Team arbeitet mit moderner Technik und führt alle Arbeiten präzise aus. Wenn Sie einen Installateur St. Pölten Umgebung oder einen Installateur St. Pölten Niederösterreich suchen, erhalten Sie professionelle Unterstützung für Heizung, Sanitär und technische Anlagen in St. Pölten.
            </p>
      ...
      <div class="card-split card-split--reverse">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Der Ablauf bei unserem Installateur St. Pölten ist klar strukturiert und kundenorientiert.
              Nach Ihrer Kontaktaufnahme über diese Seite vereinbaren wir rasch einen Termin für St. Pölten und Umgebung.
            </p>
            <p>
  ...
  <section class="service-section service-section--soft" id="region-services">
    <div class="service-container">
      <div class="card-split">
        <div class="card-split__text">
          <div class="card-box">
            <h2>Installateur Arbeiten in St. Pölten und Umgebung</h2>
            <p>
              Unser Installateur St. Pölten unterstützt Haushalte und Unternehmen bei wichtigen Installateur Arbeiten in St. Pölten sowie in der gesamten Umgebung in Niederösterreich. Viele Menschen suchen einen Installateur Nähe, der schnell erreichbar ist und zuverlässige Lösungen bietet. Genau diesen Service stellen wir bereit.
            </p>
            <p>
              Ob neue Heizung, eine moderne Heizungsanlage, Sanitär Anlagen oder andere Installationen, unser Installateur sorgt für sichere und langlebige Ergebnisse. Durch moderne Technik können Projekte effizient umgesetzt werden. Unser Ziel ist es, jedes Problem schnell zu lösen und langfristige Lösungen zu schaffen. Wenn Sie einen Installateur St. Pölten, einen Installateur St. Pölten Umgebung oder einen Installateur St. Pölten Niederösterreich benötigen, profitieren Sie von regionaler Nähe und professioneller Unterstützung.
            </p>
          </div>
        </div>
      ...
      <div class="card-split card-split--reverse">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Ein unerwarteter Rohrbruch, austretendes Wasser oder andere technische Störungen können schnell zu einem großen Problem werden. In solchen Fällen hilft unser Installateur St. Pölten rasch und zuverlässig. Unser Installateur Notdienst steht bereit, um dringende Situationen schnell zu lösen.
            </p>
            <p>
              Besonders bei einer defekten Heizungsanlage oder Problemen im Sanitär Bereich ist schnelle Hilfe wichtig. Unser erfahrener Gas Wasser Installateur prüft Ihre Anlage sorgfältig und führt eine fachgerechte Reparatur oder Rohrreinigung durch. Dank moderner Technik und zuverlässigem Service können viele Probleme schnell behoben werden. Wenn Sie einen Installateur St. Pölten Umgebung oder einen Installateur St. Pölten Niederösterreich benötigen, sind wir Ihr Ansprechpartner.
            </p>
          </div>
        </div>
  ...
  <section class="service-section service-section--soft" id="faq-services">
    <div class="service-container">
      <div class="service-section__head">
        <h2>Häufige Fragen zum Installateur St. Pölten</h2>
      ...
      <div class="service-faq">
        <details>
          ...
          <p>Unser Installateur St. Pölten bietet einen zuverlässigen Installateur Notdienst, der bei dringenden Problemen erreichbar ist. In vielen Fällen helfen wir schnell, auch außerhalb der üblichen Uhr-Zeiten.</p>
        </details>

        <details>
          <summary>Was kostet eine Rohrreinigung in St. Pölten?</summary>
        ...
        <details>
          ...
          <p>Ja, wir übernehmen die Reparatur und Wartung jeder Heizungsanlage. Unser Installateur St. Pölten sorgt dafür, dass Ihre Heizung wieder zuverlässig funktioniert.</p>
        </details>

        <details>
          <summary>Arbeiten Sie auch in der Umgebung von St. Pölten?</summary>
          <p>Ja, unser Installateur arbeitet nicht nur in St. Pölten, sondern auch in der gesamten Umgebung in Niederösterreich.</p>
        </details>

        <details>
          <summary>Übernehmen Sie Bad Installationen?</summary>
          <p>Selbstverständlich führen wir jede Bad Installation sowie alle Sanitär Arbeiten durch. Unser Installateur St. Pölten sorgt für moderne und funktionale Lösungen.</p>
        </details>

        <details>
          <summary>Wie schnell kommt ein Installateur bei Rohrbruch?</summary>
          <p>Bei einem Rohrbruch reagieren wir schnell. Unser Installateur St. Pölten kommt so rasch wie möglich, um Schäden durch austretendes Wasser zu verhindern.</p>
        </details>
      </div>
    </div>
  </section>
  ...
  @include('layout.contact', [
    ...
    'text' => 'Rufen Sie uns an oder senden Sie uns eine E-Mail. Ihr zuverlässiger Installateur in St. Pölten – für Sanitär, Heizung und Notfälle.',
