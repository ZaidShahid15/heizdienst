  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner">
      ...
      <div class="wolf-hero__logo">
        <img src="{{ asset('img/1wolf.jpeg') }}" alt="Vaillant Thermentausch Wien" loading="lazy" decoding="async">
      </div>
  ...
  <section class="service-quicktabs" id="quicktabs-services">
    <div class="service-container">
      <div class="service-tabs">
        <a class="service-tab" href="#wann-services">Wann sinnvoll</a>
        <a class="service-tab" href="#systeme-services">Systeme</a>
        <a class="service-tab" href="#ablauf-services">Ablauf</a>
        <a class="service-tab" href="#montage-services">Montage</a>
        <a class="service-tab" href="#kosten-services">Kosten</a>
        <a class="service-tab" href="#region-services">Region</a>
        <a class="service-tab" href="#warum-services">Warum Profi</a>
      ...
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/1size6.jpeg') }}" alt="Vaillant Thermentausch Wien" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
