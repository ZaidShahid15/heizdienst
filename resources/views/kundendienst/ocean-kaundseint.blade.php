  ...
  <section class="service-section service-section--soft" id="vorteile2-services">
    <div class="service-container">
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-7.jpg') }}" alt="Ocean Service Vorteile" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="service-section" id="faq-services">
    <div class="service-container">
      ...
      <div class="service-faq">
        ...
        <details>
          <summary>6. Werden auch Ocean Gasgeräte betreut?</summary>
          <p>Ja, wir betreuen Ocean Gasgeräte, Ocean Gastherme und bieten einen professionellen Gasgeräte Kundendienst.</p>
        </details>

        <details>
          <summary>7. Wie hilft der Notdienst bei Fehlern?</summary>
          <p>Bei einem Fehler reagiert der Notdienst rasch, prüft die Heizung und sorgt für eine sichere Lösung.</p>
        </details>

        <details>
          <summary>8. Ist Thermenservice auch in Wien möglich?</summary>
          <p>Ja, unser Thermenservice Wien ist für Kunden schnell verfügbar – zuverlässig und effizient.</p>
        </details>

        <details>
          <summary>9. Warum ist regelmäßige Wartung wichtig?</summary>
          <p>Regelmäßige Wartung steigert die Effizienz, senkt Heizkosten und schützt die Heizung vor Ausfällen.</p>
        </details>

        <details>
          <summary>10. Warum Ocean Service wählen?</summary>
          <p>Mit Ocean profitieren Kunden von Erfahrung, persönlichem Service, fixen Ansprechpartnern und professionellen Dienstleistungen – alles aus einer Hand.</p>
        </details>
      </div>
    </div>
  </section>
