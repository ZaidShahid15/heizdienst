  ...
  <section class="wolf-hero" id="hero-services">
    <div class="wolf-hero__inner container">
      ...
      <div class="wolf-hero__logo">
        <img src="{{ asset('img/1rapido.webp') }}" alt="Rapido-kaundseint Logo">
      </div>
        ...
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              ...
              mehr zur <a href="{{ route('ocean.thermenwartung') }}">Serviceangebot</a>.
            </p>
            <p>
      ...
      <div class="service-grid service-grid--2">
        ...
        <article class="service-feature">
          ...
          <div>
            ...
            <p>Qualifizierte Techniker und unser engagierter Serviceangebot sowie Installateure mit Erfahrung – praxisnah, professionell und lösungsorientiert.</p>
          </div>
        </article>
      ...
      <div class="card-split">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Bei Bedarf führen wir eine fachgerechte Reparatur durch und setzen auf geprüfte Ersatzteile. Mehr Informationen zur Serviceangebot.
            </p>
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-5.webp') }}" alt="Rapido Thermenwartung" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="service-section" id="reparatur-services">
    <div class="service-container">
      <div class="card-split card-split--reverse">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-6.webp') }}" alt="Rapido Thermentausch" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="service-section service-section--soft" id="team-services">
    <div class="service-container">
      <div class="card-split">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-4.webp') }}" alt="Rapido Team" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="service-section" id="preise-services">
    <div class="service-container">
      <div class="card-split card-split--reverse">
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-8.webp') }}" alt="Rapido Preise und Kosten" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-split">
        <div class="card-split__text">
          <div class="card-box">
            ...
            <p>
              Unser Serviceangebot steht Kunden jederzeit zur Verfügung – zuverlässig in jeder Jahreszeit, besonders im Winter.
            </p>
          </div>
        </div>
        ...
        <div class="card-split__media service-media">
          <div class="service-media__box">
            <img class="service-media__img" src="{{ asset('img/vaillant-9.webp') }}" alt="Rapido Einsatzgebiet" loading="lazy" decoding="async">
          </div>
        </div>
      </div>
    </div>
